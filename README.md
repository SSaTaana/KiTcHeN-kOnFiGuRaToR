  ...
  <script type="text/babel">
    ...
    const App = () => {
      ...
      const kitchenDatabase = [
        ...
        { id: 47, name: "Хай-тек Синий", length: 2.9, width: 2.1, height: 2.1, price: 155000, style: "Хай-тек", material: "MDF", color: "Синий", hasIsland: true, description: "Синий глянцевый, для современных кухонь.", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800&auto=format&fit=crop" },
        ...
        { id: 74, name: "Сканди Фиолетовый", length: 3.1, width: 2.2, height: 2.2, price: 170000, style: "Скандинавский", material: "Дерево", color: "Фиолетовый", hasIsland: false, description: "Фиолетовые акценты, для светлых интерьеров.", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800&auto=format&fit=crop" },
